...
import { runRuntimeCovariancePropagation, runRuntimeOrbitCovariancePropagation, type RuntimeCovariancePropagationResponse } from "@/services/orbitServerApi";
...
function validate(norad: string | null, orbitId: string | null, start: string, stop: string, step: string, covariance: number[][]) {
  const range = validateRuntimeTimeRange(start, stop);
