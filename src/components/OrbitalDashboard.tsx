...
const fallbackCapabilities: BackendCapabilityRegistry = {
  ...
  integrators: [
    ...
    { id: "DORMAND_PRINCE_54", label: "Dormand Prince 54", description: "Adaptive Runge-Kutta integrator.", adaptiveStep: true, backendClass: "org.hipparchus.ode.nonstiff.DormandPrince54Integrator" },
    { id: "CLASSICAL_RUNGE_KUTTA", label: "Classical Runge Kutta", description: "Fixed-step fourth-order Runge-Kutta integrator.", adaptiveStep: false, backendClass: "org.hipparchus.ode.nonstiff.ClassicalRungeKuttaIntegrator" },
    { id: "GILL", label: "Gill", description: "Fixed-step Gill fourth-order Runge-Kutta integrator.", adaptiveStep: false, backendClass: "org.hipparchus.ode.nonstiff.GillIntegrator" },
    { id: "LUTHER", label: "Luther", description: "Fixed-step high-order Luther integrator.", adaptiveStep: false, backendClass: "org.hipparchus.ode.nonstiff.LutherIntegrator" },
    { id: "MIDPOINT", label: "Midpoint", description: "Fixed-step midpoint integrator.", adaptiveStep: false, backendClass: "org.hipparchus.ode.nonstiff.MidpointIntegrator" },
    { id: "THREE_EIGHTHES", label: "Three Eighthes", description: "Fixed-step 3/8 Runge-Kutta integrator.", adaptiveStep: false, backendClass: "org.hipparchus.ode.nonstiff.ThreeEighthesIntegrator" },
    { id: "ADAMS_BASHFORTH", label: "Adams Bashforth", description: "Adaptive explicit multistep integrator.", adaptiveStep: true, backendClass: "org.hipparchus.ode.nonstiff.AdamsBashforthIntegrator" },
    { id: "ADAMS_MOULTON", label: "Adams Moulton", description: "Adaptive implicit multistep integrator.", adaptiveStep: true, backendClass: "org.hipparchus.ode.nonstiff.AdamsMoultonIntegrator" },
    { id: "GRAGG_BULIRSCH_STOER", label: "Gragg Bulirsch Stoer", description: "Adaptive extrapolation integrator.", adaptiveStep: true, backendClass: "org.hipparchus.ode.nonstiff.GraggBulirschStoerIntegrator" },
  ],
  forceModels: [],
  maneuverSupport: {
    finiteBurn: true,
